...
if __name__ == '__main__':
    db_path = r"Y:\Fawry Competition\surveillance-for-retail-stores\Surveillance-for-Retail-Stores\data\face_identification\train"  # Adjust this path to your training images database
    test_img_path = r"Y:\Fawry Competition\surveillance-for-retail-stores\Surveillance-for-Retail-Stores\data\face_identification\test\11684.jpg"  # Adjust to your test image path
